...
<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100">
         ...
         <form action="{{route('inscription')}}" class="login100-form validate-form"  method="POST" enctype="multipart/form-data">


                @csrf
					<span class="login100-form-title p-b-43">
						Inscrivez-vous pour administrer
					</span>
             @if($errors->any())
             ...
             <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                ...
                <div style="margin: 20px  20px 40px 20px; ">
                    <label for="image" style="margin-bottom: 10px ; font-size: 16px ; color: #666666">Image</label>
               ...
               <div class="text-center p-t-46 p-b-20">
						<span class="txt2">
						si vous avez déjà un compte, identifiez-vous? <a href="{{route('auth')}}" class="text-primary">Se connecter</a>
						</span>
                </div>
                <!--
